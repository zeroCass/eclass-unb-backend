...
class SubjectModelTest(TestCase):
    def setUp(self):
        Subject.objects.create(course='matemática')
        Subject.objects.create(course='português')

    def test_subject_unicode(self):
        """Testa se o curso da matéria é o esperado"""
        subject1 = Subject.objects.get(course='matemática')
        subject2 = Subject.objects.get(course='português')
